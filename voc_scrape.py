...
def should_keep(row):
    if row["Date"] == "Total" or row["Date"] == "Updated" or row["Date"] == " " or row["Date"] == "":
        return False
    elif (row["AB_B117"] == " " or row["AB_B117"] == "") and (row["AB_B1351"] == " " or row["AB_B1351"] == "") and (row["AB_P1"] == " " or row["AB_P1"] == ""):
        return False
    else:
        return True
...
def fill_in_missing_dates(b117_dict, b1351_dict, p1_dict, start_date, end_date):
    ...
    for dt in daterange(start_date, end_date):
        ...
        all_cum[dt.strftime("%Y-%m-%d")] = most_recent_p1_cases + most_recent_b117_cases + most_recent_b1351_cases

    return [b117_dict_cum, b1351_dict_cum, p1_dict_cum, all_cum]

def caclculate_daily_voc_cases(b117_dict_cum, b1351_dict_cum, p1_dict_cum, start_date, end_date):
    most_recent_b117_cases = 0.0
    most_recent_b1351_cases = 0.0
    most_recent_p1_cases = 0.0
    ...
    for dt in daterange(start_date, end_date):
        ...
        all_daily[dt.strftime("%Y-%m-%d")] = b117_cases_reported_on_day + b1351_cases_reported_on_day + p1_cases_reported_on_day
    ...
    return b117_dict_daily, b1351_dict_daily, p1_dict_daily, all_daily

def caclculate_weekly_voc_cases(b117_dict_daily, b1351_dict_daily, p1_dict_daily, start_date, end_date):
    week = 1
    current_week_days_counted = 0
    ...
    for dt in daterange(start_date, end_date):
        ...
        if (current_week_days_counted%7 == 0):
            ...
            all_weekly[str(week)] = b117_weekly_sum + b1351_weekly_sum + p1_weekly_sum
